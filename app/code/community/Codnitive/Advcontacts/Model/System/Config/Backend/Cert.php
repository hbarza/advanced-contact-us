...
class Codnitive_Advcontacts_Model_System_Config_Backend_Cert extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($value) {
            try {
                ...
                if ($condition) {
                    $err = Mage::helper('advcontacts')->__('%s extension not registered.', 
                            Mage::helper('advcontacts')->__(Codnitive_Advcontacts_Model_Config::EXTENSION_NAME));
